...
namespace XLua.CSObjectWrap
{
    ...
    public class ExampleGenConfigWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "BlackGenericTypeList", _g_get_BlackGenericTypeList);
            ...
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "BlackGenericTypeList", _s_set_BlackGenericTypeList);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_BlackGenericTypeList(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, ExampleGenConfig.BlackGenericTypeList);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_BlackGenericTypeList(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    ExampleGenConfig.BlackGenericTypeList = (System.Collections.Generic.List<System.Type>)translator.GetObject(L, 1, typeof(System.Collections.Generic.List<System.Type>));
