...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit9(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(APITest), APITestWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(GameRoot), GameRootWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Drag2D), Drag2DWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(DragUI), DragUIWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(ArgTypes), ArgTypesWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(LuaArg), LuaArgWrap.__Register);
            ...
            translator.DelayWrapLoader(typeof(LuaMonoHelper), LuaMonoHelperWrap.__Register);
